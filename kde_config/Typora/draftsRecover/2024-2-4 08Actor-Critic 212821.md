...
The baseline is useful because it can reduce the **approximation variance** when we use samples to approximate the true gradient. We can remove the weight k∇θ ln π(A|s, θt )k2 and select the
suboptimal baseline:
